...
Java_lib_kalu_bsdiff_BsdiffUtil_jnidiff(JNIEnv *env, jclass clazz, jstring old_file,
...
extern "C" JNIEXPORT jint JNICALL
Java_lib_kalu_bsdiff_BsdiffUtil_jnipatch(JNIEnv *env, jclass clazz, jstring old_file,
